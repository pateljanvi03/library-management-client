        ...
        <div class="flex flex-col">
          ...
          <div>
            ...
            <div class="flex bg-white mt-4 border rounded-lg shodow py-6 px-4">
                ...
                <div class="px-2"><input v-model="filters.ISBN" placeholder="ISBN" class="appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" /></div>
                <div class="px-2"><input v-model="filters.author" placeholder="Author" class="appearance-none text-slate-900 bg-white rounded-md block w-full px-3 h-10 shadow-sm sm:text-sm focus:outline-none placeholder:text-slate-400 focus:ring-2 focus:ring-sky-500 ring-1 ring-slate-200" /></div>
                <button @click="loadBooks" class="bg-indigo-600 px-4 py-2 flex text-white rounded ml-4">
                  <svg 
                  xmlns="http://www.w3.org/2000/svg" 
                  fill="none" 
                  viewBox="0 0 24 24" 
